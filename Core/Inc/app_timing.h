...
typedef enum
{
    APP_TIMING_SERVICE_MAIN_LOOP = CAN_PROTOCOL_TIMING_SERVICE_MAIN_LOOP,
    APP_TIMING_SERVICE_TIC12400_PROBE =
        CAN_PROTOCOL_TIMING_SERVICE_TIC12400_PROBE,
    APP_TIMING_SERVICE_CONTROL = CAN_PROTOCOL_TIMING_SERVICE_CONTROL,
    APP_TIMING_SERVICE_RTC = CAN_PROTOCOL_TIMING_SERVICE_RTC,
    APP_TIMING_SERVICE_INPUT_CAPTURE =
        CAN_PROTOCOL_TIMING_SERVICE_INPUT_CAPTURE,
    APP_TIMING_SERVICE_CAN_APP = CAN_PROTOCOL_TIMING_SERVICE_CAN_APP,
    APP_TIMING_SERVICE_TIC12400_CAN =
        CAN_PROTOCOL_TIMING_SERVICE_TIC12400_CAN,
    APP_TIMING_SERVICE_WATCHDOG = CAN_PROTOCOL_TIMING_SERVICE_WATCHDOG,
    APP_TIMING_SERVICE_COUNT = CAN_PROTOCOL_TIMING_SERVICE_COUNT
