...
typedef enum
{
    ...
    APP_LOG_EVENT_CPU_FAULT = 0x0003U,
    APP_LOG_EVENT_CPU_FAULT_STATUS = 0x0004U,
    APP_LOG_EVENT_STARTUP_DEGRADED = 0x0005U,
    APP_LOG_EVENT_TIMING_OVERRUN = 0x0006U,
    ...
    APP_LOG_EVENT_CAN_CONTROL_ACCESS_OPENED = 0x0107U,
    APP_LOG_EVENT_CAN_RX_BUDGET_EXHAUSTED = 0x0108U,
    APP_LOG_EVENT_CAN_STARTUP_FAILED = 0x0109U,
    APP_LOG_EVENT_CAN_RX_FIFO_WATERMARK = 0x010AU,
    APP_LOG_EVENT_CAN_RX_FIFO_FULL = 0x010BU,
    APP_LOG_EVENT_CAN_RX_MESSAGE_LOST = 0x010CU,
