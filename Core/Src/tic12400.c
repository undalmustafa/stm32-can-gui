...
#define TIC12400_FRAME_DATA_MASK           0x00FFFFFFUL

#define TIC12400_STATUS_SPI_FAIL_MASK      (1UL << 31)
#define TIC12400_STATUS_PARITY_FAIL_MASK   (1UL << 30)
#define TIC12400_STATUS_SSC_MASK           (1UL << 29)
#define TIC12400_STATUS_SUPPLY_MASK        (1UL << 28)
#define TIC12400_STATUS_TEMPERATURE_MASK   (1UL << 27)
#define TIC12400_STATUS_OTHER_MASK         (1UL << 26)
#define TIC12400_STATUS_POR_MASK           (1UL << 25)
    ...
    uint8_t register_address)
{
    ...
    transaction.tx_frame = TIC12400_BuildReadFrame(register_address);
