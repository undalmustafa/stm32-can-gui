...
from can_protocol_generated import (
    ...
    DIAGNOSTIC_REQUEST_RX_ID,
    DIAGNOSTIC_RESPONSE_TX_ID,
    GUI_COMMAND_ID_EXT,
    ...
    UDS_SESSION_DEFAULT,
    UDS_SESSION_EXTENDED_DIAGNOSTIC,
    UDS_VERSION,
...
DIAGNOSTIC_REQUEST_TX_ID = DIAGNOSTIC_REQUEST_RX_ID
DIAGNOSTIC_RESPONSE_RX_ID = DIAGNOSTIC_RESPONSE_TX_ID
